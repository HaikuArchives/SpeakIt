...
const rgb_color BeListGrey =			{219,219,219,	255};
...
const rgb_color DarkOrange =            {255,102,0,     255};
...
const rgb_color Magenta =				{250, 123, 255,	255};
const rgb_color Cyan =					{0, 241, 255,	255};
